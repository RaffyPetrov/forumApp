...
class PostBaseForm(forms.ModelForm):
    ...
    error_messages = {
        'title': {
            ...
            'max_length': f"This title is too long. Please keep it under {Post.TITLE_MAX_LENGTH}!",
        },
        'author': {
    ...
    def clean(self):
        ...
        if title and content and title in content:
            raise ValidationError("The post name cannot be included in the post content")
        return cleaned_data
